...
function(MAYA_PLUGIN target)
    ...
    # TBB: Maya <=2024 trae 'tbb'; Maya 2025+ (oneTBB) lo renombro a 'tbb12'.
    # Detectar cual existe en el devkit para no romper ninguna version.
    set(MAYA_TBB_LIB "tbb")
    if(NOT EXISTS "${MAYA_DEVKIT_DIR}/lib/${MAYA_LIB_PREFIX}tbb${MAYA_LIB_SUFFIX}"
       AND EXISTS "${MAYA_DEVKIT_DIR}/lib/${MAYA_LIB_PREFIX}tbb12${MAYA_LIB_SUFFIX}")
        set(MAYA_TBB_LIB "tbb12")
    endif()

    set(MAYA_LIBS Foundation OpenMaya OpenMayaAnim OpenMayaFX OpenMayaRender OpenMayaUI clew ${MAYA_TBB_LIB})
