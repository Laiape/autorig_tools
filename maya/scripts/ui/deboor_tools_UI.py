...
class BlendshapeTab(QtWidgets.QWidget):
    ...
    def _run(self):
        ...
        from importlib import reload
        from maya.scripts.utils import blendshape as bs
        reload(bs)
...
class SkinCurveTab(QtWidgets.QWidget):
    ...
    def _run(self):
        ...
        from importlib import reload
        from maya.scripts.utils import skincluster_curve as skc
        reload(skc)
...
class SkinSurfaceTab(QtWidgets.QWidget):
    ...
    def _run(self):
        ...
        from importlib import reload
        from maya.scripts.utils import skincluster_surface as sks
        reload(sks)
