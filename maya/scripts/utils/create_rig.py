...
# Utils
from maya.scripts.tools import proxy_locator
from maya.scripts.utils import guides_manager
from maya.scripts.utils import basic_structure
...
from maya.scripts.tools import skin_manager_api
from maya.scripts.tools import mesh_data_exporter
from maya.scripts.tools import auto_skin_transfer
from maya.scripts.tools import corrective_blendshape_manager
from maya.scripts.utils import picker as picker_generator
...
class AutoRig(object):
    ...
    def build(self):
        ...
        """
        from maya.scripts.ui import rig_progress
        reload(rig_progress)
